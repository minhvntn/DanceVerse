      ...
      <div className="z-10 flex flex-col items-center max-w-md w-full px-6 py-10 glass-panel rounded-3xl shadow-2xl border border-white/10">
        ...
        <div className="w-full flex flex-col gap-3 mt-4">
          <button
            ...
            className="w-full py-3.5 bg-gradient-to-r from-neon-blue to-purple-600 hover:from-neon-blue/90 text-white font-bold rounded-xl shadow-lg transition-all transform hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-2"
          >
            <span>Sign In</span>
          </button>
          ...
          <button
            ...
            className="w-full py-3.5 bg-gradient-to-r from-neon-pink to-purple-600 hover:from-neon-pink/90 text-white font-bold rounded-xl shadow-lg transition-all transform hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-2"
          >
